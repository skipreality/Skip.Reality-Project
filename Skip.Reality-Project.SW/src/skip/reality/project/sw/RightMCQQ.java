 ...
 * @author DesTrUcTioN
 */
public class RightMCQQ extends javax.swing.JFrame {

    /**
     * Creates new form RightMCQQ
     */
    public RightMCQQ() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RightMCQQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
