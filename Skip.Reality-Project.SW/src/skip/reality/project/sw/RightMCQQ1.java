 ...
 * @author DesTrUcTioN
 */
public class RightMCQQ1 extends javax.swing.JFrame {

    /**
     * Creates new form RightMCQQ1
     */
    public RightMCQQ1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Congratulation  You Have Completed The Game");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RightMCQQ1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RightMCQQ1().setVisible(true);
            }
        });
    }
